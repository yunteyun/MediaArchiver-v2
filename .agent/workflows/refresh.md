...
新しいセッション開始時、または長い中断後に以下を順番に確認してください。

## 1. 現在のフェーズを確認

`ROADMAP.md` を読んで現在のフェーズと進捗状況を把握する。

## 2. 直前の作業内容を確認

`.agent/SESSION.md` を読んで以下を確認する：
...
`CHANGELOG.md` の `[Unreleased]` セクションを確認する。
...
`.agent/decisions/` 配下の ADR を確認して、過去の設計判断を把握する。
